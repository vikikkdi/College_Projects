...
def nn(initial_pos, desired_shape, assignment):
	...
	for i, j in assignment:
		...
		y.append(gradient_descent.gradient_descent(initial_pos, desired_shape, x_star))
...
def predict(initial_pos, desired_shape, assignment):
	x = []
	for i, j in assignment:
		x.append(initial_pos[i])
		x.append(desired_shape[j])
...
def optimal_goal_formation(initial_pos, desired_shape, x_star):
	d = predict(initial_pos, desired_shape, x_star)
